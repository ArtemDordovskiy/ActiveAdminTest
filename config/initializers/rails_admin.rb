# RailsAdmin config file. Generated on February 17, 2015 13:28
...
RailsAdmin.config do |config|
  ...
  config.audit_with :history, Blog

  # Or with a PaperTrail: (you need to install it first)
  # config.audit_with :paper_trail, 'Comment'
  ...
  # config.excluded_models = ['Article', 'Blog', 'Comment', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Article', 'Blog', 'Comment', 'User']
